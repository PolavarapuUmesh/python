...
stack.append(2)
stack.append(3)
print("added a num to the list:",stack)
stack.pop()
print("popped off a num from the list:",stack)
...
queue.append(2)
queue.append(3)
print("added a num to the list:",queue)
removed_item=queue.pop(0)
print("removed the first added num to the queue:",removed_item)
print("after a num popped off from the list:",queue)

#split string by line
msg="pay attention for some time"
words=msg.split()
print(words)


#2D lists
list = [[1,23,4,2],[223,22,113,1],[12,32,1,1],[2211,1,2,11]]
list[-2].append(8080)
print(list[-2])

#create fun using 2D list 
list = [[1,23,4,2],[223,22,113,1],[12,32,1,1],[2211,1,2,11]]
def print_2d(list):
